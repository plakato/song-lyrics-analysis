...
class Network(tf.keras.Sequential):
    def __init__(self, args):
        ...
        x = layers.Embedding(args.vocab_size, 64)(encoded_input)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--lstm", default=20, type=int, help="Neurons in LSTM layer.")
    parser.add_argument("--lr", default=0.01, type=float, help="Learning rate for the optimizer.")
    parser.add_argument("--vocab_size", default=32990, type=int, help="Size of vocabulary of SubwordTextEncoder used on input.")

...
class RhymeMatrixImageBatchGenerator(tf.keras.utils.Sequence):
    ...
    def load_images(self, image_group):
        ...
        for image_path in image_group:
            ...
            # Version for color images follows.
            ...
            # elif img_shape == 3:
            #     img = cv2.cvtColor(img, cv2.COLOR_ COLOR_BGR2RGB)
...
if __name__ == "__main__":
    BASE_PATH = 'dataset_big'
    train_generator = RhymeMatrixImageBatchGenerator('dataset/train')
    val_generator = RhymeMatrixImageBatchGenerator('dataset/val')
